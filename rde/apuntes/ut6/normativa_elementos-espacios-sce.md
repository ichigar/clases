...
| Separación respecto a electricidad | ≥ 30 cm (si no hay apantallamiento)                     |
...
| Tipo de conectores        | RJ-45 hembra, estándar ISO/IEC 11801                                |
...
| ----------------------------- | --------------------------------------------------- |
| Mínimo por puesto de trabajo  | 2 tomas RJ-45 (UNE-EN 50173-1)                      |
| Categoría mínima              | Igual al cableado (Cat 5e, 6, 6A…)                  |
| Altura de instalación (pared) | ≥ 30 cm del suelo (UNE-EN 50174-2)                  |
| Tipo de conector              | RJ-45, estándar ISO/IEC 11801                       |
| Empalmes                      | Prohibidos entre panel y toma                       |
| Radio de curvatura del cable  | Mínimo 4× el diámetro del cable al llegar a la toma |
| Etiquetado                    | Obligatorio (TIA/EIA-606-B)                         |
